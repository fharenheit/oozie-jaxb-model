...
public class JaxbUtils {
     ...
     * <p>
     * <pre>
     * Marshaller marshaller = JaxbUtils.createMarshaller("io.datadynamics.shared.model.oozie.workflow.workflow");
     * </pre>
     * </p>
     ...
     * <p>
     * <pre>
     * Unmarshaller unmarshaller = JaxbUtils.createUnmarshaller("io.datadynamics.shared.model.oozie.workflow.workflow");
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link JAXBContext#createMarshaller()} 및 {@link JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
     ...
     * <pre>
     * Request requst = ...;
     * JaxbUtils.marshal(request, "io.datadynamics.shared.model.oozie.workflow.workflow", "/home/tester/test.xml", "/home/tester/test.xsd");
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link JAXBContext#createMarshaller()} 및 {@link JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
     ...
     * <pre>
     * Request requst = ...;
     * JaxbUtils.marshal(request, "io.datadynamics.shared.model.oozie.workflow.workflow", "/home/tester/test.xml");
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link JAXBContext#createMarshaller()} 및 {@link JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
     ...
     * String xml = JaxbUtils.marshal("io.datadynamics.shared.model.oozie.workflow.workflow", request);
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link JAXBContext#createMarshaller()} 및 {@link JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
     ...
     * <p>
     * <pre>
     * Request request = (Request) JaxbUtils.marshal("io.datadynamics.shared.model.oozie.workflow.workflow", "/home/tester/xml", "test.xml");
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link JAXBContext#createMarshaller()} 및 {@link JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
     ...
     * Request request = (Request) JaxbUtils.marshal("io.datadynamics.shared.model.oozie.workflow.workflow", xml);
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link JAXBContext#createMarshaller()} 및 {@link JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
     ...
     * Request request = (Request) JaxbUtils.marshal("io.datadynamics.shared.model.oozie.workflow.workflow", inputStream);
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link JAXBContext#createMarshaller()} 및 {@link JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
     ...
     * Request request = (Request) JaxbUtils.marshal("io.datadynamics.shared.model.oozie.workflow.workflow", reader);
     * </pre>
     * </p>
     * <b>이 메소드를 반복적으로 호출하면 성능 문제가 발생한다. {@link JAXBContext#createMarshaller()} 및 {@link JAXBContext#createUnmarshaller()} 메소는
     * 반복적으로 호출하는 경우 성능 문제를 발생하기 때문이다.</b>
