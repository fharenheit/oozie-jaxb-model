 ...
 *         &lt;element name="prepare" type="{uri:oozie:hive-action:0.5}PREPARE" minOccurs="0"/&gt;
 *         &lt;element name="job-xml" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="configuration" type="{uri:oozie:hive-action:0.5}CONFIGURATION" minOccurs="0"/&gt;
