 ...
 *       &lt;sequence&gt;
 *         &lt;element name="delete" type="{uri:oozie:hive-action:0.5}DELETE" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="mkdir" type="{uri:oozie:hive-action:0.5}MKDIR" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
