 ...
 *       &lt;sequence&gt;
 *         &lt;element name="delete" type="{uri:oozie:distcp-action:0.2}DELETE" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="mkdir" type="{uri:oozie:distcp-action:0.2}MKDIR" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
