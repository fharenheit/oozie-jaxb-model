 ...
 *       &lt;sequence&gt;
 *         &lt;element name="delete" type="{uri:oozie:sqoop-action:0.4}DELETE" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="mkdir" type="{uri:oozie:sqoop-action:0.4}MKDIR" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
