 ...
 * generated in the io.datadynamics.shared.model.oozie.workflow package. 
...
public class ObjectFactory {
    ...
    private final static QName _WorkflowApp_QNAME = new QName("uri:oozie:workflow:0.5", "workflow-app");
    private final static QName _Switch_QNAME = new QName("uri:oozie:workflow:0.5", "switch");
    private final static QName _Kill_QNAME = new QName("uri:oozie:workflow:0.5", "kill");
    private final static QName _MapReduce_QNAME = new QName("uri:oozie:workflow:0.5", "map-reduce");
    private final static QName _Pig_QNAME = new QName("uri:oozie:workflow:0.5", "pig");
    private final static QName _SubWorkflow_QNAME = new QName("uri:oozie:workflow:0.5", "sub-workflow");
    private final static QName _Fs_QNAME = new QName("uri:oozie:workflow:0.5", "fs");
    private final static QName _Java_QNAME = new QName("uri:oozie:workflow:0.5", "java");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.datadynamics.shared.model.oozie.workflow
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "uri:oozie:workflow:0.5", name = "switch")
     ...
     * 
     */
    @XmlElementDecl(namespace = "uri:oozie:workflow:0.5", name = "kill")
     ...
     * 
     */
    @XmlElementDecl(namespace = "uri:oozie:workflow:0.5", name = "map-reduce")
     ...
     * 
     */
    @XmlElementDecl(namespace = "uri:oozie:workflow:0.5", name = "pig")
     ...
     * 
     */
    @XmlElementDecl(namespace = "uri:oozie:workflow:0.5", name = "sub-workflow")
     ...
     * 
     */
    @XmlElementDecl(namespace = "uri:oozie:workflow:0.5", name = "fs")
     ...
     * 
     */
    @XmlElementDecl(namespace = "uri:oozie:workflow:0.5", name = "java")
